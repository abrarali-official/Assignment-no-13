...
function App() {
    return ( <
        ...
        <
        h3 style = {
            { marginTop: "10px" } } > Title of a longer < br / > featured blog post < /h3> <
        p className = "mul" > Multiple lines of text that form the data informing new readers quickly and efficently about what 's most interesting in this post'
        s contents. < /p> <
        h5 style = {
            { padding: '11px' } } > Continue reading... < /h5> <
        /div> <
        /div> <
        /div> <
        /div>
        ...
        <
        div className = "card" > { /* <img class="card-img-top" src="img_avatar1.png" alt="Card image">  */ } <
        div className = "card-body" >
        <
        h5 style = {
            { color: 'blue' } } > < b > World < /b></h
        5 >
        <
        h4 className = "card-title" > < b > Featured Post < /b></h
        4 >
        <
        text > Nov 12 < /text> <
        ...
        a style = {
            { textDecoration: 'none' } }
        href = "www.google.com" > Continue reading < /a> <
        /div> <
        /div> <
        /div>
        ...
        <
        h5 style = {
            { color: 'green' } } > < b > Design < /b></h
        5 >
        <
        h4 className = "card-title" > < b > Post Title < /b></h
        4 >
        <
        text > Nov 11 < /text> <
        p > Lorem ipsum dolor sit amet, consectetur adipisicing elit.Assumenda corrupti qui quisquam laudantium hic quo, culpa molestias eius repellendus similique! < /p> <
        ...
        class = "btn btn-outline-primary" > Older < /button> <
        button type = "button"
        style = {
            { borderRadius: '20px', marginTop: '30px', marginLeft: '3px' } }
        class = "btn btn-outline-dark" > Newer < /button>
        ...
        <
        div style = {
            { backgroundColor: 'rgb(240, 240, 240)', color: 'black' } } >
        <
        div style = {
            { padding: '8px' } } >
        <
        ...
        href = "" > March 2014 < /a> <
        a className = 'anker'
        href = "" > February 2014 < /a> <
        a className = 'anker'
        href = "" > January 2014 < /a> <
        a className = 'anker'
        href = "" > December 2013 < /a> <
        a className = 'anker'
        href = "" > November 2013 < /a> <
        a className = 'anker'
        href = "" > October 2013 < /a> <
        a className = 'anker'
        href = "" > September 2013 < /a> <
        a className = 'anker'
        href = "" > August 2013 < /a> <
        a className = 'anker'
        href = "" > July 2013 < /a> <
